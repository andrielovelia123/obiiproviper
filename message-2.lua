...
--==[ Nova Hub Farm LoaderKid UI Functions ]==--

local loaderScreenGui, blur, startTime, timerLabel

function ShowLoaderKid()
    startTime = tick()
    ...
    nova.Font = Enum.Font.GothamBold
    nova.TextSize = 40
    nova.TextColor3 = Color3.fromRGB(173, 216, 230)
    nova.BackgroundTransparency = 1
    nova.Size = UDim2.new(0.5, 0, 0.3, 0)
    nova.Position = UDim2.new(0, 0, 0, 0)
    nova.TextXAlignment = Enum.TextXAlignment.Right
    ...
    hub.Font = Enum.Font.GothamBold
    hub.TextSize = 40
    hub.TextColor3 = Color3.fromRGB(221, 160, 221)
    hub.BackgroundTransparency = 1
    hub.Size = UDim2.new(0.5, 0, 0.3, 0)
    hub.Position = UDim2.new(0.5, 0, 0, 0)
    hub.TextXAlignment = Enum.TextXAlignment.Left
    ...
    -- Footer
    local credit = Instance.new("TextLabel")
    credit.Text = "Nova Hub Auto Trial"
    credit.Font = Enum.Font.Gotham
    credit.TextSize = 14
    ...
    spawn(function()
        ...
        while loaderScreenGui and timerLabel and status do
            ...
            timerLabel.Text = string.format("Elapsed: %02d:%02d:%02d", hours, minutes, seconds)

            local race = player:FindFirstChild("Data") and player.Data:FindFirstChild("Race") and player.Data.Race.Value or "Unknown"
            status.Text = "Race: " .. race
...
function HideLoaderKid()
    if blur and blur.Parent then
        blur:Destroy()
        blur = nil
    end

    if loaderScreenGui and loaderScreenGui.Parent then
        loaderScreenGui:Destroy()
        loaderScreenGui = nil
    end
end
